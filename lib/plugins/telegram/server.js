...
const add = (message, name, host, port, password) => {
  flowSaverServer.add(name, host, port, password).then(success => {
...
const edit = (message, oldName, name, host, port, password) => {
  flowSaverServer.edit(oldName, name, host, port, password).then(success => {
...
const del = (message, name) => {
  flowSaverServer.del(name).then(success => {
