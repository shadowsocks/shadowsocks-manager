...
app.controller('AdminAccountController', ['$scope', '$state', '$stateParams', '$http', 'accountSortDialog', '$interval', '$sessionStorage', 'accountSortTool',
  ($scope, $state, $stateParams, $http, accountSortDialog, $interval, $sessionStorage, accountSortTool) => {
    $scope.setTitle('账号');
    ...
    $scope.accountMethod = $sessionStorage.settings.accountFilter;
    $scope.setFabButton(() => {
