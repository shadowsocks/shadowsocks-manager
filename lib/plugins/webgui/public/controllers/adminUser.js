...
.controller('AdminUserPageController', ['$scope', '$state', '$stateParams', '$http', '$mdDialog', 'adminApi', 'orderDialog',
  ($scope, $state, $stateParams, $http, $mdDialog, adminApi, orderDialog) => {
    $scope.setTitle('用户信息');
    ...
    getUserData();
    $http.get('/api/admin/order', { params: {
      userId,
    } }).then(success => {
