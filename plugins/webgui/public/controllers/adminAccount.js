...
app.controller('AdminAccountController', ['$scope', '$state', '$stateParams', '$http', 'accountSortDialog', '$interval', '$sessionStorage',
  ($scope, $state, $stateParams, $http, accountSortDialog, $interval, $sessionStorage) => {
    $scope.setTitle('账号');
