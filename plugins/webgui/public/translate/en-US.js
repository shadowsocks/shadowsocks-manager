module.exports = {
  ...
  '复制二维码链接': 'Copy the QR Code link',
  '流量倍率：': 'Flow Rate:',
  '订阅链接': 'Subscribe URL',
  '请选择订阅链接类型：': 'Select the type:',
  '将域名转换为IP地址': 'Convert domain name to IP address',
  '显示流量信息': 'Show flow information',
  '复制链接': 'Copy',
  '更换链接': 'Change',
  '注意：': 'Attention:',
  '此处修改的密码为Shadowsocks的密码': 'The password modified here is the password of Shadowsocks',
  '充值码': 'Recharge Code',
  '请添加 Telegram 账号': 'Please add the Telegram account',
  '并输入': 'and then input',
  '完成绑定': 'to complete binding',
  '解除绑定': 'Unbind',
  '邀请码': 'Invitation Link',
  '没有可用的邀请码': 'No invitation link available',
  '复制链接': 'Copy',
  '已邀请用户': 'Invited User',
  '当前没有邀请用户': 'No users currently invited',
};
