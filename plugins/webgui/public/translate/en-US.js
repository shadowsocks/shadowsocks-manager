module.exports = {
  ...
  '网站标题': 'Website Title',
  '使用Service Worker缓存静态页面': 'Use Service Worker to cache static pages',
  '新用户自动分配账号': 'Assign account to new users',
  '随机分配端口号': 'Randomize port numbers',
  '开放注册': 'Enable registration',
  '合并多服务器流量统计': 'Merge traffic flow statistics of multiple servers',
  '注册时间': 'Joined',
  '上次登录': 'Last logined',
