module.exports = {
  ...
  '官方标准':'Official API',
  '仅依赖Node.js，无需安装数据库（可选MySQL）': 'Depends on Node.js and SQLite (optionally MySQL)',
  '带有插件系统，仅需修改配置文件即可运行': 'Plugin-based, super-easy deployment',
  '支持libev和python版本的标准manager API': 'Support standard manager API of both ss-libev and ss-python',
  '请输入邮箱地址再点击“找回密码”': 'Please fill in your E-mail address first',
  '邮箱不能为空': 'Email address cannot be empty',
  '验证码不能为空': 'Code cannot be empty',
  '密码不能为空': 'Password cannot be empty',
  '验证码已发至邮箱': 'A verification code has been sent to your E-mail account',
  ...
  '最新注册用户': 'Last Registered Users',
  '最近登录用户': 'Last Logined Users',
  '支付宝订单': 'Alipay Orders',
