module.exports = {
  ...
  '网站标题': 'Website Title',
  '主题颜色': 'Primary Theme Color',
  '主题颜色': 'Secondary Theme Color',
  ...
  '流量比例': 'Flow Weight',
  '端口偏移': 'Port Offset',
  '真的要删除服务器吗？': 'Are you sure to delete this server?',
  '请填写加密方式':'Please input the encryption method',

  '接收消息推送': 'Receive push message',
  '您的推荐链接': 'Your Referral Link',
  '正在获取...': 'Fetching...',
  '获取推荐链接失败': 'Fetching referral link failed',
  '推荐记录': 'Referral Results',
  '已推荐用户数': 'Referred Signups',
  '已获得流量': 'Bonus Data',
  '已获得时长': 'Bonus Time',
  '获取推荐记录失败': 'Getting referral results failed',
  '奖励流量（MB）': 'Bonus Data',
  '奖励时长（天）': 'Bonus Time',
  '您已经从该IP地址注册过': 'You cannot signup more than 1 account from a same IP address',
  '不合法注册': 'Invalid signup',
  '您不能推荐用户从同一IP地址注册': 'You cannot refer a user from a same IP address',
